...
$q1="select *from staff where sid='$sid'";
...
.place{
  ...
  <body>
    <ion-app>
        ...
        <ion-title align="center"  position="floating">staff Details Modification</ion-title>      
    </ion-toolbar>
  </ion-header>
<ion-content>
      ...
      <ion-col size-xl="7" >
            ...
            <ion-col size-xl="5">
                ...
                <ion-item class='mycolor2'>
                  ...
                  <ion-item class='mycolor2'>
                    <ion-label position="floating">sid No</ion-label>
                    <ion-icon name="person" slot="start"></ion-icon>
                    <ion-input class='place'  name='sid' id="sid" type="number" value='<?php echo "$sid"; ?>' onkeyup="validation(id)" readonly></ion-input>
                  </ion-item>
...
var fi=document.getElementById('sid');
...
$q="UPDATE `staff` SET `sid`='$sid',`name`='$name',`fname`='$fname',`mname`='$mname',`dob`='$dob',`aadhar`='$aadhar',`passport`='$passport',`gender`='$gender',`h_no`='$h_no',`street`='$street',`city`='$city',`state`='$state',`country`='$country',`pin`='$pin',`phone`='$phone',`email`='$email' WHERE `sid`=$sid";
