...
if($_POST){
    ...
    echo "<ion-app>";
echo "<ion-header ><ion-toolbar color='secondary' position='floating' class='ion-text-center'><ion-title>Faculty Details<ion-title></ion-toolbar></ion-header>";
...
while($row=mysqli_fetch_array($result))
{
    ...
    echo "<ion-item color='dark'>"."<ion-label>Fid</ion-label>".$row['fid']."</ion-item>";
