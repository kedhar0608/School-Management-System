...
echo "$dob ,$admin,$name,$fname,$mname,$dob,$aadhar,$passport,$gender,$h_no,$street,$city,$state,$country,$pin";

$q="INSERT INTO student values( '$admin','$name','$fname','$mname','$dob','$aadhar','$passport','$gender','$h_no','$street','$city','$state','$country','$pin')";
