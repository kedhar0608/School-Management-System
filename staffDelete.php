...
.mycolor2 {
  ...
  <body>
    <ion-app>
        ...
        <ion-title align="center"  position="floating">Student Details Deletion</ion-title>      
    </ion-toolbar>
  </ion-header>
            ...
            <ion-col size-xl="5">
                ...
                <ion-item class='mycolor2'>
                  ...
                  <ion-item class='mycolor2'>
                    ...
                    <ion-icon name="person" slot="start"></ion-icon>
                    <ion-input class='place'   name='sid1' id="sid1" type="number" value='<?php echo "$sid"; ?>'   readonly></ion-input>
                  </ion-item>
