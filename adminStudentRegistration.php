...
.place{
  ...
  <body>
    <ion-app>
        ...
        <ion-title align="center"  position="floating">Student Registration Form</ion-title>      
    </ion-toolbar>
  </ion-header>
<ion-content class='myview' >
  <ion-fab horizontal="end" vertical="start" slot="fixed">
    ...
    <ion-fab-list>
      ...
      <ion-fab-button color="dark" href="admin_student_registration.html">
        <p title="student Registration"><ion-icon name="bowtie"></ion-icon></p>
      </ion-fab-button>
            ...
            <ion-col size-xl="5">
                ...
                <ion-item class='mycolor2'>
                  ...
                  <ion-item class='mycolor2'>
                    ...
                    <ion-icon name="person" slot="start"></ion-icon>
                    <ion-input class='place'  placeholder='student Id' name='admin' id="admin" type="number" value="" onkeyup="validation(id)"></ion-input>
                  </ion-item>
...
$q="INSERT INTO `student` (`admin_no`, `name`, `fname`, `mname`, `dob`, `aadhar`, `passport`, `gender`, `h_no`, `street`, `city`, `state`, `country`, `pin`,`phone`,`email`) VALUES ('$admin', '$name', '$fname', '$mname', '$dob', '$aadhar', '$passport', '$gender', '$h_no', '$street', '$city', '$state', '$country', '$pin','$phone','$email')";
