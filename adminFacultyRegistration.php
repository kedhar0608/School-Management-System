...
@keyframes myEffect2 {
  ...
  <body>
    <ion-app>
        ...
        <ion-title align="center"  position="floating">Faculty Registration Form</ion-title>      
    </ion-toolbar>
  </ion-header>
<ion-content class='myview' >
  <ion-fab horizontal="end" vertical="start" slot="fixed">
    ...
    <ion-fab-list>
      ...
      <ion-fab-button color="dark" href="admin_faculty_registration.html">
        <p title="Faculty Registration"><ion-icon name="bowtie"></ion-icon></p>
      </ion-fab-button>
        ...
        <ion-row>
            ...
            <ion-col size-xl="5">
                ...
                <ion-item class='mycolor2'>
                  ...
                  <ion-item class='mycolor2'>
                    <ion-label position="floating"> Fid</ion-label>
                    <ion-icon name="person" slot="start"></ion-icon>
                    <ion-input class='place'  placeholder='Faculty Id' name='fid' id="fid" type="number" value="" onkeyup="validation(id)"></ion-input>
                  </ion-item>
